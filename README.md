...
> Answer: It is easier on the server because there are no hard reloads and everything flows more smoothly.
...
- [x]  Use a styling or component library for part of or all of your application. (Pick at least 1 of:[x](https://react-bootstrap.github.io/)styled-components or Reactstrap).
